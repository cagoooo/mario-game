import { Player } from './Player.js?v=1.6.10';
import { Background, Biomes } from './Background.js?v=1.6.10';
import { InputHandler } from './InputHandler.js?v=1.6.10';
import { generatePlatforms } from './Platform.js?v=1.6.10';
import { createEnemies } from './Enemy.js?v=1.6.10';
import { checkCollision } from './utils.js?v=1.6.10';
import { Coin, generateCoins } from './Coin.js?v=1.6.10';
import { QuestionBlock, generateQuestionBlocks } from './QuestionBlock.js?v=1.6.10';
import { Mushroom } from './Mushroom.js?v=1.6.10';
import { Star } from './Star.js?v=1.6.10';
import { FireFlower } from './FireFlower.js?v=1.6.10';
import { Fireball } from './Fireball.js?v=1.6.10';
import { Pipe, generatePipes } from './Pipe.js?v=1.6.10';
import { Lava } from './Lava.js?v=1.6.10';
import { EnhancedAudioSystem } from './AudioSystem.js?v=1.6.10';
