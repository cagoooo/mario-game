import { Game, preloadImages } from './Game.js?v=1.6.22';

window.onload = async function () {
    console.log('%c Game Version: 1.8.0 (Optimization: Particle Pooling) ', 'background: #222; color: #00ff00; font-size: 20px; padding: 10px;');
