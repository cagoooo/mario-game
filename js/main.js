import { Game, preloadImages } from './Game.js?v=1.6.23';

window.onload = async function () {
    console.log('%c Game Version: 1.6.23 (Missing Method Fix) ', 'background: #222; color: #00ffff; font-size: 20px; padding: 10px;');
