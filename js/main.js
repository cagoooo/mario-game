import { Game } from './Game.js?v=2.9.0';
import { AssetLoader } from './AssetLoader.js?v=2.9.0';

window.onload = async function () {
    console.log('%c Game Version: 2.9.0 (Phase 4-5 Performance & Content) ', 'background: #222; color: #00ff00; font-size: 20px; padding: 10px;');
