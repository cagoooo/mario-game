import { Game, preloadImages } from './Game.js?v=1.6.19';

window.onload = async function () {
    console.log('%c Game Version: 1.6.19 (Duplicate Fix) ', 'background: #222; color: #00ffff; font-size: 20px; padding: 10px;');
