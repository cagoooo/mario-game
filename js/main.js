import { Game, preloadImages } from './Game.js?v=1.9.1';

window.onload = async function () {
    console.log('%c Game Version: 1.9.1 (Fix: Landscape Aspect Ratio) ', 'background: #222; color: #00ff00; font-size: 20px; padding: 10px;');
