import { Game } from './Game.js?v=2.18.0';
import { AssetLoader } from './AssetLoader.js?v=2.18.0';

window.onload = async function () {
    console.log('%c Game Version: 2.18.0 (Performance Optimization) ', 'background: #222; color: #00ff00; font-size: 20px; padding: 10px;');
