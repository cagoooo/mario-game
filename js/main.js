import { Game } from './Game.js?v=2.17.4';
import { AssetLoader } from './AssetLoader.js?v=2.17.4';

window.onload = async function () {
    console.log('%c Game Version: 2.17.4 (iOS Safari Fix v2) ', 'background: #222; color: #00ff00; font-size: 20px; padding: 10px;');
