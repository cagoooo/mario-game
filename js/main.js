import { Game, preloadImages } from './Game.js?v=1.5.7';

window.onload = async function () {
    console.log('%c Game Version: 1.5.7 (Balance: Child Friendly Speed) ', 'background: #222; color: #00ffff; font-size: 20px; padding: 10px;');
