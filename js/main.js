import { Game, preloadImages } from './Game.js?v=1.5.6';

window.onload = async function () {
    console.log('%c Game Version: 1.5.6 (Fix: Import Caching) ', 'background: #222; color: #00ffff; font-size: 20px; padding: 10px;');
