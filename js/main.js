import { Game, preloadImages } from './Game.js?v=1.5.8';

window.onload = async function () {
    console.log('%c Game Version: 1.5.8 (Balance: High Loot Chance) ', 'background: #222; color: #00ffff; font-size: 20px; padding: 10px;');
