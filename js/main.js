import { Game } from './Game.js?v=2.17.3';
import { AssetLoader } from './AssetLoader.js?v=2.17.3';

window.onload = async function () {
    console.log('%c Game Version: 2.17.3 (iOS Safari Landscape Fix) ', 'background: #222; color: #00ff00; font-size: 20px; padding: 10px;');
